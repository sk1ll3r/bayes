...
\input{basics/prob/poisson} \\
\input{basics/prob/gamma} \\
\input{basics/prob/NB} \\
\input{basics/prob/categorical} \\
\input{basics/prob/dirichlet} \\
\input{basics/prob/multinomial} \\
\input{basics/prob/dirichlet-multinomial} \\
\bottomrule
\end{tabulary}
